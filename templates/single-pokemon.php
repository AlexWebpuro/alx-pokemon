		...
		<div class="row">
				...
				<main class="site-main" id="main">
					...
					while ( have_posts() ) {
						...
						// echo get_the_post_thumbnail( $post_id, array( 'class' => 'screen-photo' ) );
						...
						$type = get_post_meta( $post_id, '_pokemon_type', true )
						...
						<!-- <ul>
							...
							<li> <?php // echo $type?></li>
							<li> <?php // echo $pokedex_old_index?></li>
							<li> <?php // echo $pokedex_new_index?></li>
						</ul> -->
						<?php
